...
/**
 * Shared webview markup for both the sidebar chat view and the full-screen chat panel — the two
 * speak the same postMessage protocol (chat/clear in, userMessage/streamChunk/toolCall/... out),
 * so there's exactly one HTML/CSS/client-script implementation to keep in sync.
 */
export function getChatHtmlContent(model: string): string {
...
<body>
    <div id="app">
        <div id="header">
            ...
            <div id="header-right">
                <span id="model-badge">${escapedModel}</span>
